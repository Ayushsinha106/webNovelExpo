...
const Background = ({ navigation, route }) => {
  ...
  console.log(details);
  const imgUrl = details.Details?.imgUrl || ""; // Use a default string if url is null/undefined
  const status = details.Details?.status || ""; // Use a default string if url is null/undefined
  const title = details.Details?.title || ""; // Use a default string if url is null/undefined
  const chapters = details.chapters?.chap || []; // Use a default string if url is null/undefined
  const Author = details.Details?.author || "";

  const TotalChapters = details.Details?.TotalChapters || ""; // Use a default string if url is null/undefined
